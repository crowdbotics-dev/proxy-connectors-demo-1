"""
Django settings for proxy_connectors_demo_1 project.
...
ROOT_URLCONF = "proxy_connectors_demo_1.urls"
...
WSGI_APPLICATION = "proxy_connectors_demo_1.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "proxy_connectors_demo_1 API",
    "DESCRIPTION": "API documentation for proxy_connectors_demo_1 App",
    "VERSION": "v1",
}
