...
## Project Structure
    ...
    ├── proxy_connectors_demo_1  # Django project configurations
...
1. Clone this repo and `cd proxy_connectors_demo_1`
...
2. Clone this repo and `cd proxy_connectors_demo_1`
